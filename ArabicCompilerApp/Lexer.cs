...
namespace ArabicCompiler
{
    public class Lexer
    {
        ...
        // جدول الكلمات المفتاحية محدث بالكامل
        ...
        private Token ReadCharLiteral()
        {
            ...
            if (CurrentChar != '\'')
            {
                throw new LexerException("Character literal must contain exactly one character.", startLine, startCol);
            }
            Advance(); // تخطي '
        ...
        public Token NextToken()
        {
            ...
            switch (CurrentChar)
            {
                ...
                case '=':
                    ...
                    return new Token(TokenType.ASSIGN, "=", null, startLine, startCol);

                case '!':
                    Advance();
                    return new Token(TokenType.NOT, "!", null, startLine, startCol);
